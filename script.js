...
document.getElementById('lang-toggle').addEventListener('click', function() {
    if (isSpanish) {
        ...
        document.getElementById('introduction-text').innerText = 'Hello! I am Chema Vásquez , your local guide and passionate painter, ready to share with you the wonders of San Juan La Laguna. Here, I will not only take you to explore amazing landscapes but also offer you an authentic experience with my Tz’utujil family. Get ready to live an unforgettable adventure!';
